...
// If you change this namespace to your own namespace, the action selection dropdown
// menu will group your condition(s) into submenus by namespace.
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestConditionTemplate : QuestCondition // Rename this class -- e.g., "MyCustomQuestCondition"
    {
