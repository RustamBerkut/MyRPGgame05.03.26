...
// menu will group your content type(s) into submenus by namespace.
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestContentTemplate : QuestContent // Rename this class -- e.g., "MyCustomQuestContent"
    {
